...
{
    /// <summary>NATS-based implementation of IBroadcastBus.</summary>
    public sealed class BroadcastBus : IBroadcastBus
    {
        ...
        public BroadcastBus(IBroadcastBusOptions options)
        {
        ...
        public void Initialize()
        {
            ...
            // Start only what the mode asks for
        ...
        private NatsOpts CreateNatsOptions()
        {
            ...
            // If you load a client cert from Windows store, attach it here (reuse your current logic).
            return builder;
        }
